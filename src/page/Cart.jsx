...
import { removeFromCart, resetCart, setCartClose } from '../slices/cartSlice'
...
export default function Cart() {
  ...
  const CheckOutHandler = async() => {
    ...
    await BuyProduct(total, resetCart, dispatch);
  ...
  return (
    <Transition.Root show={cartOpen} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={() => dispatch(setCartClose)}>
        <Transition.Child
          as={Fragment}
